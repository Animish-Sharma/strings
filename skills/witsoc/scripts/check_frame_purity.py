...
EXCLUDED_DIRS = {"domains", "packages", "dist", ".git", "__pycache__", ".venv", "node_modules",
...
EXEMPT_FILES = {
    ...
    # Generated at release time from every shipped file. It necessarily names
    # domain paths and content; it is integrity metadata, not frame doctrine.
    ".witsoc-manifest.json",
    ...
    # Generated from package-owned selection blocks and payload digests. The
    # core reads it as an installation index; it is not frame doctrine.
    "contracts/domain-packages.json",
    ...
    # Contains field-specific routing probes used only to test package loading.
    "scripts/check_domain_packages.py",
}
